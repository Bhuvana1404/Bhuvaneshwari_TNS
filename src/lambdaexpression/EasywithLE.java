...
public class EasywithLE {
	public static void main(String[] args) {
		...
		Operations opr;//common single reference variable is opr
		...
		//check for Number Pallindrome
		Pallindrome<Integer> intPalin;
		intPalin=(data) ->
		{
			int rev=0, no=data;
			while(no!=0)
